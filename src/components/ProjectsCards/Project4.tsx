...
const Project4 = (props: Props) => {
    return (
            ...
            <div  className="w-screen  flex-shrink-0  snap-center flex flex-col space-y-3 items-center  justify-center p-10  ">
                ...
                <div>
                     <Link href="https://mic-mac.vercel.app/" className='text-lg font-semibold underline hover:text-violet-500 2xl:text-2xl  text-center md:text-left'>Mic Mac: A food delivery platform </Link>
                </div>
            </div>
